...
/**
 * A relation that is equal to another SymmetricRelation, if both elements
 * match, even if they are swapped.
 * 
...
public class SymmetricRelation<T1, T2> {
	...
	public int hashCode() {
		...
		if (a == null) {
			return prime * b.hashCode();
		}
		if (b == null) {
			return prime * a.hashCode();
		}
	...
	public boolean equals(Object obj) {
		...
		return (a.equals(other.a) && b.equals(other.b) || a.equals(other.b)
				&& b.equals(other.a));
	}
