...
public class MultiSet<E> implements Iterable<Tuple<E, Integer>> {
	...
	Map<E, Integer> elements = new LinkedHashMap<E, Integer>();
	 ...
	 * @param addedElements
	 */
	public void addOccurrences(Iterable<E> addedElements) {
	 ...
	 * 
	 * @param element
	 * @return : false if this set does not contain any occurrence of this
	 *         object.
	 */
	 ...
	 */
	public void removeOccurrences(Iterable<E> removedElements) {
