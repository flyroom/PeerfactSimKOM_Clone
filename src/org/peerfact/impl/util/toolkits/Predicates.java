...
public class Predicates {
	 ...
	 */
	private static final Predicate<?> NO_FILTER = new Predicate<Object>() {
		@Override
	...
	public static <T> Predicate<T> getFilterNothing() {
		return (Predicate<T>) NO_FILTER;
	}

	/**
	 * A predicate that is false for everything.
	 */
	private static final Predicate<?> ALL_FILTER = new Predicate<Object>() {
		@Override
	...
	public static final Predicate<Host> IS_ISOLATION_AFFECTED = new Predicate<Host>() {
		@Override
		public boolean isTrue(Host host) {
			HostProperties properties = host.getProperties();
			return properties.isIsolationAffected();
		}
	};
