 ...
 * 
 * @author Tobias Lauinger <tl1003@rbg.informatik.tu-darmstadt.de> Some methods
 *         added by Leo Nobach.
 * 
 * @version 05/06/2011
 */
public class CollectionHelpers {
	...
	public static <E> E getRandomEntry(Collection<E> coll) {
		if (coll instanceof List) {
			return getRandomEntry((List<E>) coll);
		}
		if (coll.size() == 0) {
			return null;
		}
	...
	/**
	 * Randomly returns maxSize elements from in, or less if in is smaller than
	 * maxSize.
	 * 
	 * @param <T>
	 * @param in
	 ...
	 * @return
	 */
	public static <T> List<T> getRandomPartFrom(Collection<? extends T> in,
			int maxSize) {
	...
	/**
	 * Transforms a list into another one, element by element, given a
	 * Transformer.
	 * 
	 * @param <Ts>
	 * @param <Tt>
	 ...
	 * @return
	 */
	public static <Ts, Tt> List<Tt> transformList(List<Ts> sourceList,
			Transformer<Ts, Tt> transformer) {
