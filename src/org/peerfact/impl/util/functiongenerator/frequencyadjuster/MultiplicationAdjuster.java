...
/**
 * This frequency adjuster multiplies the current frequency of a function by a
 * given amount.
 * 
...
public class MultiplicationAdjuster extends FrequencyAdjuster {
	 ...
	 * 
	 * @param simTime
	 *            Simulation time at which the multiplication adjuster shall be
	 *            executed
	 * @param function
	 *            Function to be changed
	 * @param factor
	 *            Factor by which the frequency is multiplied
	 * @param interval
	 *            Interval in which the frequency shall be adjusted (0 =
	 *            non-repeating)
	 */
	public MultiplicationAdjuster(long simTime, Function function,
			double factor, long interval) {
