...
public class LimitedNormalDistribution implements Distribution {
	...
	@XMLConfigurableConstructor({ "mu", "sigma", "min", "max", "limitedMin",
			"limitedMax" })
	public LimitedNormalDistribution(double mu, double sigma, double min,
			double max, boolean limitedMin, boolean limitedMax) {
		conf = new LimitedNormalConfigurer(mu, sigma, min, max, limitedMin,
				limitedMax);
		config(conf);
	}
	...
	private static class LimitedNormalConfigurer {
		private double mu;
