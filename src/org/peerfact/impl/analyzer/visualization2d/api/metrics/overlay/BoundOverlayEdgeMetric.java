...
/**
 * Adapter / Decorator bounds a metric to an edge. Then it is no longer
 * necessary to pass an edge, because the metric is already bound to an edge.
 * 
