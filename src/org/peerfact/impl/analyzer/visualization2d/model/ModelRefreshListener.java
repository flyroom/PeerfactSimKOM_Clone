...
/**
 * Waiting for necessary updates of the display.
 * 
...
public interface ModelRefreshListener {
	...
	/**
	 * Is executed when the model needs a refresh.
	 */
	public void modelNeedsRefresh(VisDataModel model);

	/**
	 * Was performed when a new data model had been loaded.
	 */
	public void newModelLoaded(VisDataModel model);

	/**
	 * Is executed when the data model is completed by the finished simulation.
	 */
