...
/**
 * An OverlayAdapter, which enables to cluster the network according to
 * Bootstrap-managers that the nodes need to join.
 * 
...
public interface MultiBootstrapCapable {
	...
	/**
	 * Returns the BootstrapManager, used for node.
	 * 
	 * @param node
	 * @return
	 */
