...
public abstract class AbstractGnpNetBandwidthManager {
	...
	public AbstractGnpNetBandwidthManager() {
		connectionsSenderToReceiver = new LinkedHashMap<AbstractNetLayer, Map<AbstractNetLayer, GnpNetBandwidthAllocation>>();
		connectionsReceiverToSender = new LinkedHashMap<AbstractNetLayer, Map<AbstractNetLayer, GnpNetBandwidthAllocation>>();
	}
	...
	public GnpNetBandwidthAllocation addConnection(AbstractNetLayer sender,
		...
		if (!connectionsSenderToReceiver.containsKey(sender)) {
			connectionsSenderToReceiver
					.put(sender,
							new LinkedHashMap<AbstractNetLayer, GnpNetBandwidthAllocation>());
		}
	...
	public Set<GnpNetBandwidthAllocation> removeConnections(
		...
		Set<GnpNetBandwidthAllocation> connections = new LinkedHashSet<GnpNetBandwidthAllocation>();
