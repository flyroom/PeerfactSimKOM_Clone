...
public class BitmapHeader {
	...
	public static int getInt(byte[] in, int offset) {
	...
	public static int getInt3(byte[] in, int offset) {
	...
	// build an int from a byte array - convert little to big endian
	public static long getLong(byte[] in, int offset) {
	...
	public static double getDouble(byte[] in, int offset) {
