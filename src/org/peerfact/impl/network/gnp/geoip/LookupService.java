 ...
 * log.debug(&quot;The country is: &quot; + country.getName());
 * log.debug(&quot;The country code is: &quot; + country.getCode());
 * </pre>
 * 
...
public class LookupService {
	...
	private static Logger log = SimLogger.getLogger(LookupService.class);
	...
	private final static LinkedHashMap<String, Integer> hashMapcountryCodetoindex = new LinkedHashMap<String, Integer>(
			512);

	private final static LinkedHashMap<String, Integer> hashMapcountryNametoindex = new LinkedHashMap<String, Integer>(
			512);
	...
	private void init() throws IOException {
		...
		if (file == null) {
			...
			for (i = 0; i < 233; i++) {
				hashMapcountryCodetoindex.put(countryCode[i],
						Integer.valueOf(i));
				hashMapcountryNametoindex.put(countryName[i],
						Integer.valueOf(i));
			}
			return;
		}
	...
	public static Location getLocationwithdnsservice(String str) {
