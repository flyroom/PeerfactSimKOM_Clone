...
public class PingErToolkit {
	...
	public static JitterParameter getJitterParameterFrom(double avgRtt,
			double minRtt, double dVar) {
	 ...
	 * parameters mu and sigma that minimized the error between measured
	 * expectation and iqr and the resulting expectation and iqr.
	 * 
	 * @param expectation
	 *            value
	 * @param iqr
	...
	/**
	 * Container the log-normal distribution parameters. Used in the Downhill
	 * Simplex method.
	 * 
	 */
	public static class JitterParameter implements Comparable<JitterParameter> {
		 ...
		 * 
		 * @return error (variation between measured expectation and iqr and the
		 *         resulting log-normal expectation and iqr.
		 */
