 ...
 * 
 * Packet Loss at the Network Layer can have many causes, like interference on
 * the physical layer or congestion in intermediate routers which causes them to
...
public interface PLossStrategy extends ModNetLayerStrategy {
	...
	/**
	 * Returns if the given network message shall be dropped because of network
	 * layer packet loss.
	 * 
	 * @param msg
	 *            : the message to be dropped or not
	 * @param nlSender
	 *            : the sender's network layer of the message
	 * @param nlReceiver
	 *            : the receiver's network layer of the message
	 * @param db
