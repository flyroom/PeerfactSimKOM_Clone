...
public class RoutedJitter implements JitterStrategy {
	...
	public long getJitter(long cleanMsgPropagationDelay, NetMessage msg,
		...
		// Jitter is provided by the subnet, which acts as a strategy
		RoutedSubnet rSubnet = (RoutedSubnet) nlSender.getSubnet();
		return rSubnet.getJitter(cleanMsgPropagationDelay, msg, nlSender,
				nlReceiver, db);
	}
