...
public class VonNodeFactory implements ComponentFactory {
	...
	private static BootstrapManager<VonNode> bootstrap;
	...
	public static void setBootstrapManager(BootstrapManager<VonNode> bootstrap) {
		VonNodeFactory.bootstrap = bootstrap;
	}
