 ...
 */
public class CIOverlayID implements OverlayID<BigInteger> {

	private BigInteger id;

	public CIOverlayID(NetID id) {
		this.id = getID(id.toString());
	}

	public CIOverlayID(BigInteger id) {
		this.id = id;
	}
	...
	public int compareTo(OverlayID<BigInteger> arg0) {
		if (arg0 == null) {
			...
			BigInteger fid = ((CIOverlayID) arg0).getID();
	...
	public boolean equals(Object obj) {
		...
		CIOverlayID other = (CIOverlayID) obj;
		if (id == null) {
			if (other.id != null) {
				return false;
			}
