 ...
 */
public class ClientJoinRequestMsg extends AbstractCIRequestMsg<TransInfo>
		implements JoinLeaveMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7162457106094324593L;

	public ClientJoinRequestMsg(CIOverlayID sender,
			CIOverlayID receiver, TransInfo content, int opID) {
		super(sender, receiver, content, opID);
	}

	@Override
	public long getSize() {
		return super.getSize() + getContent().getTransmissionSize();
	}
}
