...
public class ResponsibilityRequestMsg extends
		AbstractCIRequestMsg<CIOverlayKey> implements LookupMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3966411117633277295L;

	public ResponsibilityRequestMsg(CIOverlayID sender,
			CIOverlayID receiver, CIOverlayKey content, int opID) {
