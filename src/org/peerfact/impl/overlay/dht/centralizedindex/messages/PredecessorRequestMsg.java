...
public class PredecessorRequestMsg extends
		AbstractCIRequestMsg<CIOverlayID> implements LookupMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3394199259554518190L;

	public PredecessorRequestMsg(CIOverlayID sender,
			CIOverlayID receiver, CIOverlayID content, int opID) {
