...
public class ResponsibilityReplyMsg extends
		AbstractCIReplyMsg<ResponsibleForKeyResult> implements
		LookupMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5579256418431188117L;

	public ResponsibilityReplyMsg(CIOverlayID sender,
			CIOverlayID receiver, ResponsibleForKeyResult result, int opID) {
		super(sender, receiver, result, opID);
	}

	@Override
	public long getSize() {
		return super.getSize() + getResult().getTransmissionSize();
	}
}
