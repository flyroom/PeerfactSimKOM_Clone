...
public class PredecessorReplyMsg extends
		AbstractCIReplyMsg<CIOverlayContact> implements LookupMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 173649131931187662L;

	public PredecessorReplyMsg(CIOverlayID sender,
			CIOverlayID receiver, CIOverlayContact result, int opID) {
