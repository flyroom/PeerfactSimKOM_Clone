...
public class ClientJoinReplyMsg extends
		AbstractCIReplyMsg<CIOverlayID> implements JoinLeaveMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -207285489764695571L;

	public ClientJoinReplyMsg(CIOverlayID sender,
			CIOverlayID receiver, CIOverlayID result, int opID) {
