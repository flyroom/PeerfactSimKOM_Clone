 ...
 */
public class ResponsibleForKeyResult implements Transmitable {

	private Boolean responsibiltyFlag;

	private CIOverlayContact napsterContact;

	public ResponsibleForKeyResult(CIOverlayContact contact, Boolean flag) {
	...
	public CIOverlayContact getNapsterContact() {
		return napsterContact;
	}

	@Override
	public long getTransmissionSize() {
		return napsterContact.getTransmissionSize() + Constants.BOOLEAN_SIZE;
	}
}
