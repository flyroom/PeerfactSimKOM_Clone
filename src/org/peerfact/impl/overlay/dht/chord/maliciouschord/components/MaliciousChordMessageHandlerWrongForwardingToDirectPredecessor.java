 ...
 */
public class MaliciousChordMessageHandlerWrongForwardingToDirectPredecessor
		extends AbstractMaliciousChordMessageHandler {

	/**
	 * @param node
	 */
	public MaliciousChordMessageHandlerWrongForwardingToDirectPredecessor(
