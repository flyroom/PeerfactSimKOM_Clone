 ...
 */
public class MaliciousChordMessageHandlerWrongForwardingToClosestFingertableSuccessor
		extends AbstractMaliciousChordMessageHandler {

	/**
	 * @param node
	 */
	public MaliciousChordMessageHandlerWrongForwardingToClosestFingertableSuccessor(
	...
	public void doMaliciousHandleLookupMsg(LookupMessage lookupMsg) {
		...
		if (routingTable.responsibleFor(target)
			...
			AbstractChordContact succeedingFinger = MaliciousLookupOperationWrongForwardingToClosestFingertableSuccessor
					.getClosestSucceedingFinger(routingTable, target);
