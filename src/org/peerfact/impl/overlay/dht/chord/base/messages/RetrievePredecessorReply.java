 ...
 * @version 05/06/2011
 */
public class RetrievePredecessorReply extends AbstractReplyMsg implements
		IStabilizeMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3114008525969011926L;

	private final AbstractChordContact predecessor;

	public RetrievePredecessorReply(AbstractChordContact senderContact,
