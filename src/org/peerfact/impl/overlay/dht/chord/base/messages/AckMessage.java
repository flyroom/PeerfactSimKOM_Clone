 ...
 * @version 05/06/2011
 */
public class AckMessage extends ChordMessage implements ISetupMessage {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5130016123305466051L;
	...
	public AckMessage(AbstractChordContact senderContact,
	...
	@Override
	public long getSize() {
		return Constants.INT_SIZE + Constants.BOOLEAN_SIZE
				+ super.getSize();
	}
