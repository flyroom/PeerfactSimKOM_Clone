...
import org.peerfact.impl.overlay.dht.chord.chord.callbacks.CheckPredecessorOperation;
import org.peerfact.impl.overlay.dht.chord.chord.callbacks.CheckSuccessorOperation;
import org.peerfact.impl.overlay.dht.chord.chord.callbacks.UpdateDirectSuccessorOperation;
import org.peerfact.impl.overlay.dht.chord.chord.operations.UpdateFingerPointOperation;
...
public class ChordRoutingTable extends AbstractChordRoutingTable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1011252302341902525L;
	...
	// methods for malicious nodes

	public AbstractChordContact[] getFinger() {
		return this.finger;
	}
