...
public abstract class AbstractRequestMsg<T extends OverlayID<?>> extends
		AbstractOverlayMessage<T> {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5473292114388819537L;
	...
	public String toString() {
		return "" + getClass().getSimpleName() + "(" + getSender() + " -> "
				+ getReceiver() + ", content: " + this.content + ")";
	}
