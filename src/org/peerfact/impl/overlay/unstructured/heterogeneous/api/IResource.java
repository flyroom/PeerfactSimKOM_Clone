...
/**
 * Abstract resource that is published and queried in the network. Can be
 * anything that can be matched to a given query info.
 * 
 * @author Leo Nobach <peerfact@kom.tu-darmstadt.de>
 * 
 * @version 05/06/2011
 */
public interface IResource extends DHTEntry<DHTKey<?>>, DHTValue {
