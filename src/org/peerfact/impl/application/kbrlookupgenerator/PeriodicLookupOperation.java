...
public class PeriodicLookupOperation extends
		RandomIntervalPeriodicOperation<KBRLookupGenerator, Boolean> {

	private KBRLookupGenerator generator;

	private boolean delayed;

	public PeriodicLookupOperation(KBRLookupGenerator generator,
